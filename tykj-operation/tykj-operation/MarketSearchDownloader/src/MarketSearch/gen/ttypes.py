...
class ApkFileStatus(object):
    ...
    def __init__(
            self, source_link=None, url=None, source=None, status=None, vol_id=None, package_name=None, version_code=None, signature=None,
            version_name=None, apk_size=None, min_sdk_version=None, screen_support=None, is_break=None, file_type=None, platform=None, package_hash=None,):
        self.source_link = source_link
        self.url = url
        self.source = source
        self.status = status
