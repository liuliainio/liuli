...
SYS_DEPS=( python-pip python-software-properties python2.6-dev libxml2-dev python-mysqldb) # add python*-dev libxml2-dev for uwsgi 

PYTHON_DEPS=( "django==1.3" "pymongo==2.3" "django-smart-selects==1.0.4") # as i known, uwsgi newest version 1.2.1 doesn't work with nginx 1.2.0'
